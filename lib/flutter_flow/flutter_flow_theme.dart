...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF1C86C2);
  late Color secondaryColor = const Color(0xFFD9D9D9);
  late Color tertiaryColor = const Color(0xFFC7C7C7);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFF5F6F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF1C86C2);
  late Color secondaryText = const Color(0xFF0F3253);
